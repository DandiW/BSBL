      ...
      function chordTip (d, id) {
        ...
        var val = 
          $.get("api/" + year + "/" + source + "/" + target, function(data, status){
            ...
            text += "</ul>";
            $("#" + id).html(text);
            embedPlayers(trades[0].transaction_id);
          });
        return "Loading";
      }

      function embedPlayers(transaction_id) {
